...
with query_window as (
    ...
    where lower(query_type) = 'select'
        ...
        and start_time >= dateadd(day, -{{ var('table_materialization_lookback_days', 14) }}, getdate())
