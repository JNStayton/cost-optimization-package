...
--#}
{% macro find_incremental_materialization_candidates(min_table_size_gb=10, max_build_time_sec=600, lookback_days=30, include_package_models=false) %}
...
{% macro default__find_incremental_materialization_candidates(min_table_size_gb=10, max_build_time_sec=600, lookback_days=30, include_package_models=false) %}
  {% if execute %}
